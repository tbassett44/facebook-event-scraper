...
exports.getEndTimestampAndTimezone = exports.getOnlineDetails = exports.getHosts = exports.getLocation = exports.getUserStats = exports.getTicketUrl = exports.getBasicData = exports.getDescription = void 0;
...
const getLocation = (html) => {
    ...
    return {
        ...
        address: (_h = (_g = jsonData.address) === null || _g === void 0 ? void 0 : _g.street) !== null && _h !== void 0 ? _h : null, // address doesnt exist for custom location events, and is set to an empty string for cities
        city: jsonData.city
            ? {
